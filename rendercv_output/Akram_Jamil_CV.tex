...
\begin{document}
    ...
    \section{Education}
        ...
        \begin{threecolentry}{\textbf{BCFM}}{
            Sept 2024 – Apr 2029
        }
            \textbf{University of Waterloo}, Computing \& Financial Management
            \begin{highlights}
                \item \textbf{Majors:} Computer Science, Accounting \& Fincance
                \item GPA: 3.9/4.0
    ...
    \section{Experience}
        ...
        Sept 2020 – present
            ...
            \textbf{Kumon Canada}, Teaching Assistant
            \begin{highlights}
    ...
    \section{Technologies}
        ...
        \begin{onecolentry}
            \textbf{Languages:} C, Python, Dart, Flutter, SQL, JavaScript, HTML, CSS, Flask, matplotlib, numpy
        \end{onecolentry}

        \vspace{0.2 cm}

        \begin{onecolentry}
            \textbf{Technologies:} Visual Studio Code, XCode, Android Studio, Blender
        \end{onecolentry}
