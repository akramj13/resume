...
\begin{document}
    ...
    \section{Education}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item \textbf{Relevant Coursework:} Analyzing Financial Markets (Python), Designing Programs (Racket), Algorithm Design and Data Structures (C), Techniques for Software Development (Git/GitHub/Bash/Linux)
            \end{highlights}
        \end{onecolentry}
    ...
    \section{Technologies}
        ...
        \begin{onecolentry}
            \textbf{Tools/Technologies:} Visual Studio Code, Android Studio, Jupyter Notebook, LaTeX, Blender, Git/GitHub, Figma, Linux
        \end{onecolentry}
