...
\patchcmd{\ps@customFooterStyle}{\thepage}{
    \color{gray}\textit{\small Akram Jamil - Page \thepage{} of \pageref*{LastPage}}
...
\begin{document}
    ...
    \section{Projects}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Developed a convolutional neural network (CNN) and a Random Forest classifier to classify images and clinical data to determine the likelyhood of a patient having Alzheimer's Disease
                \item Collaborated in a team of three to integrate machine learning models (Random Forest, Meta Classifier) for analyzing MRI scans, providing predictions with accuracy scores above 85\%
                \item Enhanced early detection capabilities for Alzheimer’s, potentially reducing diagnostic time by 30\% compared to traditional methods.
            \end{highlights}
        \end{onecolentry}
        ...
        \begin{onecolentry}
            \textbf{CFM101 Stock Trading Project}
        \end{onecolentry}

        \vspace{0.10 cm}
        \begin{onecolentry}
            \begin{highlights}
                \item Technical Analysis Project
            \end{highlights}
        \end{onecolentry}
    ...
    \section{Technologies}
        ...
        \begin{onecolentry}
            \textbf{Languages:} C/C++, Python, Dart, SQL, JavaScript, HTML, CSS,
        \end{onecolentry}

        \vspace{0.2 cm}

        \begin{onecolentry}
            \textbf{Libraries:} Matplotlib, NumPy, NumPy Financial, pandas, yfinance, Flask, React, Flutter
        \end{onecolentry}

        \vspace{0.2 cm}

        \begin{onecolentry}
            \textbf{Technologies:} Visual Studio Code, XCode, Android Studio, Next.js, MongoDB, Blender, Git/GitHub, Figma
        \end{onecolentry}
