...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://akramj.work/}{\color{black}{\footnotesize\faLink}\hspace*{0.13cm}akramj.work}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
    ...
    \section{Education}
        ...
        \textit{Sep 2024 to Apr 2029}}
            ...
            \textit{Bacehlor's in Computing \& Financial Management (Honors)}
        \end{twocolentry}
