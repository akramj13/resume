    ...
    \section{Projects}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Developed a convolutional neural network (CNN) and a Random Forest classifier to classify images and clinical data to determine the likelihood of a patient having Alzheimer's Disease
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Built an AI-Powered Webscraper that can pull data from any website, given a prompt, using a Meta's Ollama AI.
                \item Utilizes Natural Language Processing (NLP) to automatically scrape desired content of any kind based on a user prompt from a given website URL.
