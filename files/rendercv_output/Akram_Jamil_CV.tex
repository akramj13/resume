...
\begin{document}
    ...
    \section{Technologies}
        ...
        \begin{onecolentry}
            \textbf{Languages:} C, Python, Dart, Flutter, SQL, JavaScript, HTML, CSS, Flask
        \end{onecolentry}

        \vspace{0.2 cm}

        \begin{onecolentry}
            \textbf{Technologies:} Visual Studio Code, XCode, Android Studio, Blender, matplotlib, numpy
        \end{onecolentry}
