...
\begin{document}
    ...
    \section{Technologies}
        ...
        \begin{onecolentry}
            \textbf{Developer Tools/Technologies:} VS Code, Android Studio, Jupyter Notebook, LaTeX, Blender, Git, Figma, Linux, Bash
        \end{onecolentry}
    ...
    \section{Education}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item \textbf{Relevant Coursework:} Financial Markets \& Data Analytics (Python), Designing Programs (Racket), Algorithm Design and Data Structures (C), Techniques for Software Development (Git/GitHub/Bash/Linux)
            \end{highlights}
        \end{onecolentry}
    ...
    \section{Projects}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Engineered the front-end and AI model using React, Python, HTML, and CSS for an Alzheimer’s detection tool aimed at physicians, which won a \textbf{\$1,000} prize at YIC.
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Programmed a Random Forest Classifier in Python using Scikit-Learn, \textbf{trained on 10,000+ data points} of stock prices and trading volumes, combined with technical indicators to achieve a 15\% improvement in predictive accuracy for market trends.
